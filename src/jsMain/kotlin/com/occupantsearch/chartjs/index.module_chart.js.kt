...
external interface PluginDescriptor {
    var plugin: Chart.PluginServiceGlobalRegistration /* Chart.PluginServiceGlobalRegistration & Chart.PluginServiceRegistrationOptions */
}
...
open external class PluginServiceStatic {
    ...
    open fun getAll(): Array<Chart.PluginServiceGlobalRegistration /* Chart.PluginServiceGlobalRegistration & Chart.PluginServiceRegistrationOptions */>
    open fun notify(
        chart: Chart,
